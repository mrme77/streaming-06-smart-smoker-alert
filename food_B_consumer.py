...
This script monitors temperature readings for 'Food B' and triggers a 'Food B Alert' based on specific conditions. 
...
Alert Trigger:
- If the temperature decreases by 1°F or more within the specified time window, a 'Food B Alert' is triggered.

Usage:
- Run this script to start monitoring 'Food B' temperature readings. It will continuously listen for messages and 
